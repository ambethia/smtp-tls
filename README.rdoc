...
((<don't need this|URL:http://github.com/rails/rails/commit/732c724df61bc8b780dc42817625b25a321908e4>)). Just set +enable_starttls_auto+ in your +ActionMailer+ config:
